...
export function userMigrationTemplate(_dialect: string): string {
...
export function oauthAccountMigrationTemplate(_dialect: string): string {
  return `import type { Schema } from "jsxserve";
...
export function refreshTokenMigrationTemplate(_dialect: string): string {
  return `import type { Schema } from "jsxserve";
